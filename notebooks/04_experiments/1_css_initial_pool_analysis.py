...
# python this_script.py path/to/seqs/seqs.csv path/to/baseline/data/
# For example:
# python 1_css_initial_pool_analysis.py path/to/11ultramerseqs.csv /Users/leeorg/Documents/MISL/cas9/nanopore_sim_search/20220627_1431_MN40387_FAT53551_1a7f07f8
