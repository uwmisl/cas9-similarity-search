...
# python this_script.py path/to/seqs/seqs.csv path/to/baseline/data/data.csv path/to/experiment/data/directory
#
# For example (this would all be one line in the command line):
# python 2_css_run_analysis.py
# path/to/11ultramerseqs.csv
# /Users/leeorg/Documents/MISL/cas9/nanopore_sim_search/20220627_1431_MN40387_FAT53551_1a7f07f8/unmodified_pool.csv
# /Users/leeorg/Documents/MISL/cas9/nanopore_sim_search/11ultramers_20220808/20220808_1602_MN21390_FAT57906_9180b0f5

##########
##########
from css_analysis_functions import *
import sys
import pandas as pd
