...
subtrans = np.array([[ 0.        ,  1.16616601,  0.96671383,  0.94917742],
                     [ 0.94076049,  0.        ,  1.18426595,  0.87129983],
                     [ 0.58224486,  1.11064886,  0.        ,  1.04707949],
                     [ 0.9633753 ,  0.98895548,  1.2293125 ,  0.        ]]).astype(np.float32)
...
def log10_crispr_spec(seq_pairs):
    ...
    #subst_ids = tf.sqrt(tf.einsum('...i,...j->...ij', ref, obs))
